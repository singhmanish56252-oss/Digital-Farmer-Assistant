                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-4">
                          <div className="w-16 h-16 rounded-xl overflow-hidden shadow-sm flex-shrink-0">
                            <img src={`${import.meta.env.BASE_URL}${detail.image}`} alt={fert} className="w-full h-full object-cover" />
                          </div>
                          <div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="h-48 w-full relative">
                <img src={`${import.meta.env.BASE_URL}${selectedFertilizer.image}`} alt={selectedFertilizer.name} className="w-full h-full object-cover" />
